...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhanggaojv/LoginModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhanggaojv' => '3039801314@qq.com' }
  s.source           = { :git => 'https://github.com/zhanggaojv/LoginModule.git', :tag => s.version.to_s }
